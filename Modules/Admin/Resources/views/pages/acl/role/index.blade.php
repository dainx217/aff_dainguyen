    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
        ...
        <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">Role</h1>
                <!--end::Heading-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                ...
                <a href="../../demo7/dist/index.html" class="d-flex align-items-center">
                    <img alt="Logo" src="{{ asset('affassets/src/media/logos/logo-demo7.svg') }}"
                        class="h-30px" />
                </a>
                <!--end::Logo-->
            </div>
            ...
            <div class="d-flex flex-shrink-0">
                ...
                <div class="d-flex ms-3">
                    <a href="{{ route('get_admin.role.create') }}"
                        ...
                        <!--end::Svg Icon-->
                        <span class="d-none d-md-inline">Add Role</span>
                    </a>
                </div>
                <!--end::Invite user-->
            ...
            <div class="card">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                            ...
                                            data-select2-id="select2-data-10-ky34" tabindex="-1" aria-hidden="true">
                                            ...
                                            dir="ltr" data-select2-id="select2-data-11-xo77" style="width: 100%;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-disabled="false" aria-labelledby="select2-xfoj-container"
                                                    aria-controls="select2-xfoj-container"><span
                                                        class="select2-selection__rendered" id="select2-xfoj-container"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                            ...
                                            data-select2-id="select2-data-13-dqag" tabindex="-1" aria-hidden="true">
                                            <option data-select2-id="select2-data-15-8mrx"></option>
                                            <option value="Enabled">Enabled</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-14-c7nl" style="width: 100%;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-disabled="false" aria-labelledby="select2-ms32-container"
                                                    aria-controls="select2-ms32-container"><span
                                                        class="select2-selection__rendered" id="select2-ms32-container"
                                                        role="textbox" aria-readonly="true" title="Select option"><span
                                                            class="select2-selection__placeholder">Select
                                                            option</span></span><span class="select2-selection__arrow"
                                                        role="presentation"><b
                ...
                " style="width: 29.25px;">
                                        ...
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            ...
                                            style="width: 238.938px;">Name</th>
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending"
                                            style="width: 150.344px;">Time</th>
                                        <th class="text-end min-w-100px sorting_disabled" rowspan="1" colspan="1"
                                            aria-label="Actions" style="width: 116.938px;">Actions</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{ route('get_admin.role.edit', $item->id) }}"
                                                    ...
                                                    <a href="{{ route('get_admin.role.delete', $item->id) }}"
                                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm js-delete">
