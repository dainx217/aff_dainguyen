						...
						<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="d-flex flex-shrink-0">
								...
								<div class="d-flex ms-3">
									<a href="{{ route('get_admin.permission.index') }}" class="btn btn-flex flex-center bg-body btn-color-gray-700 btn-active-color-primary w-40px w-md-auto h-40px px-0 px-md-6" >
